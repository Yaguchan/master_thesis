...
def tone():
    ...
    before_max_deltas = [12.5, 25, 50, 100, 200, 400, 800]
    after_max_deltas = [100, 100, 100, 100, 200, 400, 800]
    ...
    list_all_deltas = []
    for max_deltas in [before_max_deltas, after_max_deltas]:
        all_deltas = []
        ...
        list_all_deltas.append(all_deltas)
    ...
    for sl, (all_deltas, colors) in enumerate(zip(list_all_deltas, list_colors)):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(IMGDIR, f'dl_test1.png'))
    plt.show()
