...
def main():
    ...
    print(before_value(1100)-before_value(150))
    print(after_value(600)-after_value(400))
    print(after_value(150)-after_value(100))
    exit()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(IMGDIR, f'ps_speech.png'))
    plt.show()
